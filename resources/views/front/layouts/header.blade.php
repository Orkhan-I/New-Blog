...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
    @if($config->logo!==null)
      <a class="navbar-brand" href="{{route('homepage')}}"><img class="navbar-brand" src="{{$config->logo}}" width="200"  alt=""></a>
      @else  <a class="navbar-brand" href="{{route('homepage')}}">{{$config->title}}</a>
    @endif
